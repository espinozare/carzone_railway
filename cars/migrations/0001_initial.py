    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('DUB', 'Dublin'), ('CORK', 'Cork'), ('GAL', 'Galway'), ('LIM', 'Limerick'), ('WAT', 'Waterford'), ('BEL', 'Belfast'), ('KIL', 'Kilkenny'), ('DRO', 'Drogheda'), ('DUN', 'Dundalk'), ('SLI', 'Sligo'), ('ENN', 'Ennis'), ('TRA', 'Tralee'), ('ATH', 'Athlone'), ('NAV', 'Navan'), ('CAR', 'Carlow'), ('LET', 'Letterkenny'), ('NEW', 'Newry'), ('ARD', 'Ardmore'), ('BAN', 'Bangor'), ('WEX', 'Wexford')], max_length=100)),
